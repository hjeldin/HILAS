 ...
 *
 *  file:  include\YouBotKinematicsModel.hpp
...
namespace motion_stack
{
	...
	class YouBotKinematicsModel: virtual Submodel20sim
	{
	public:

		/**
		 * YouBotKinematicsModel constructor
		 */
		YouBotKinematicsModel();

		/**
		 * YouBotKinematicsModel destructor
		 */
		virtual ~YouBotKinematicsModel(void);
