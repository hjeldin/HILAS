 ...
 *
 *  file:  include\SimpleEnergySupplyModel.hpp
...
namespace motion_stack
{
	...
	class SimpleEnergySupplyModel: virtual Submodel20sim
	{
	public:

		/**
		 * SimpleEnergySupplyModel constructor
		 */
		SimpleEnergySupplyModel();

		/**
		 * SimpleEnergySupplyModel destructor
		 */
		virtual ~SimpleEnergySupplyModel(void);
