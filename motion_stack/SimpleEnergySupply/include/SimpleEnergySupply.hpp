 ...
 *
 *  file:  include\SimpleEnergySupply.hpp
...
/* This file describes the model functions
 ...
 The model itself is the SimpleEnergySupplyModel.cpp file
 */
...
namespace motion_stack
{
	...
	class SimpleEnergySupply: public SimpleEnergySupplyModel , public RTT::TaskContext
	{
	public:
		//enum stateflags_SimpleEnergySupply {initialrun, mainrun, finished};

		/**
		 * SimpleEnergySupply constructor
		 */
		SimpleEnergySupply(std::string name = "SimpleEnergySupply");

		/**
		 * SimpleEnergySupply destructor
		 */
		virtual ~SimpleEnergySupply(void);

		/**
		 * SimpleEnergySupply configuration code and returns false if startup fails
		 */
		bool configureHook ();

		/**
		 * SimpleEnergySupply startUp code and returns false if startup fails
		 */
		bool startHook ();

		/**
		 * SimpleEnergySupply Calculation executed in this Hook.
		 */
		void updateHook ();

		/**
		 * SimpleEnergySupply Terminate
		 */
		void stopHook ();
