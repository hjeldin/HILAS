...
SIM_TOPIC_ARM_JOINT_STATES_RX = "/vrep/hw_rx/arm_1/joint_state"
SIM_TOPIC_BASE_JOINT_STATES_RX = "/vrep/hw_rx/base/joint_state"
SIM_TOPIC_ODOM_STATE_RX = "/vrep/hw_rx/odom"
